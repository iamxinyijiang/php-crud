            ...
            <nav>
                <ul>
                    <li><button class="button" onclick="window.location.href='insertCabin.php'">Insert a New
                            Cabin</button></li>
                    <li><button class="button" onclick="window.location.href='updateCabin.php'">Update a Cabin</button>
                    </li>
                    <li><button class="button" onclick="window.location.href='deleteCabin.php'">Delete a Cabin</button>
                    </li>
                    <li><button class="button" onclick="window.location.href='allCabins.php'">View All Cabins</button>
                    </li>
                </ul>
            </nav>
        </div>
